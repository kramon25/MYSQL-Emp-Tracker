...
showRoles = () => {
  ...
  const sql = `SELECT role.id AS id, role.title AS Roles, role.salary AS Salary, department_id AS Department FROM role `;
  ...
  const questions = [
    {
      ...
      name: "first_name",
      message:
        "what is the first name of this employee?(Please use single quotes)",
    },
    {
      type: "input",
      name: "last_name",
      message:
        "what is the last name of this employee?(Please use single quotes)",
    },
    {
      type: "input",
      name: "role_id",
    ...
    },
    {
      ...
      name: "manager_id",
      message:
        "what is the id of the manager of this employee?(1-7 or NULL if none)",
    },
  ];
